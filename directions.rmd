...
* `pull_from_svdbs.R` - Executed sql query and pulls daa from SVDBS database
...
annualCondition <- RelConditionEPU(pullNewData = TRUE, out.dir="output")
# plot results
plot_condition(annualCondition,out.dir="output")
# analysis
gam_calcs(annualCondition,out.dir="output")
...
annualCondition <- RelConditionEPU(pullNewData = FALSE, out.dir="output")
print(annualCondition)
```

### Plotting

Use the function `plot_condition`. This is not currently functional. I will leave it up to you to finish it. It currently takes the argument annualCondition which is the output from the main function.
