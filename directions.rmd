...
condMat <- plot_condition(condition$annualcond,filename = "condition_2018", out.dir = "output")
 ...
 data.dir <- "data"
condMat <- plot_condition((readr::read_csv(here::here(data.dir, "AnnualRelCond2018_GOM.csv"))), filename = "GOM_condition_2018", out.dir = "output")

condMat <- plot_condition((readr::read_csv(here::here(data.dir, "AnnualRelCond2018_GB.csv"))), filename = "GB_condition_2018", out.dir = "output")
                          
condMat <- plot_condition((readr::read_csv(here::here(data.dir, "AnnualRelCond2018_MAB.csv"))), filename = "MAB_condition_2018", out.dir = "output")
                          
condMat <- plot_condition((readr::read_csv(here::here(data.dir, "AnnualRelCond2018_SS.csv"))), filename = "SS_condition_2018", out.dir = "output")                          
```
