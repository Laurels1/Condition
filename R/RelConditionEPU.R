...
#rgdal no longer available with recent R versions
...
#Paring by EPU using corrected conversions in survdat package and Wigley et all L-W params (add third : because post_strat is now an internal function):
