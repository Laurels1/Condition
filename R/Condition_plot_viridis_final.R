...
saveRDS(Regime[["cptable"]],file = here::here("output", "Cond_Shelf_Regimes_2023.RDS"))
printcp(Regime)
...
ggsave(path= here::here(out.dir),"Shelf_Condition_allsex_2023.jpg", width = 8, height = 3.75, units = "in", dpi = 300)
